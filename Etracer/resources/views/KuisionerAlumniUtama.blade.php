    ...
    <div class="wrap-contact100">
      <form class=" contact100-form validate-form" action="{{ url('/KuisionerUtama/simpanUtama') }}">
        ...
        <div class="wrap-input100 ">
          ...
          <br>
            <tr>
              <td><input type="radio" name="Tanggapan18" value="Saya masih belajar/melanjutkan kuliah profesi atau pascasarjana" required></td>
              <td> Saya masih belajar/melanjutkan kuliah profesi atau pascasarjana</td>
            </tr>
            <br>
            <tr>
              <td><input type="radio" name="Tanggapan18" value="Saya menikah"></td>
              <td> Saya menikah</td>
            </tr>
            <br>
            <tr>
              <td><input type="radio" name="Tanggapan18" value="Saya sibuk dengan keluarga dan anak-anak"></td>
              <td>Saya sibuk dengan keluarga dan anak-anak</td>
            </tr>
            <br>
            <tr>
            <td><input type="radio" name="Tanggapan18" value="Saya sekarang sedang mencari pekerjaan"></td>
            <td> Saya sekarang sedang mencari pekerjaan</td>
            </tr>
            <br>
            <tr>
              <td><input class="rd" type="radio" name="Tanggapan18" id="radio-1" value="Lainnya" checked= /><input type="text" class="tb" name="tb1"  placeholder=" Lainnya" /></td>
            </tr>
        </div>
