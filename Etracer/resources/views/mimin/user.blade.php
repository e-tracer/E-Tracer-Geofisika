              ...
              <div class="sparkline8-list shadow-reset">
                ...
                <div class="sparkline8-graph">
                  <div class="static-table-list">
                    <a href="tambahUser"> + Tambah User </a>
                    <table class="table">
                      <thead>
                        <tr>
                          <th>ID User</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{$p->tgl_lahir}}</td>
                          <td>
                            <a href="editUser/{{$p->id_user}}"><i class="glyphicon glyphicon-pencil"></i></a> |
                            <a href="hapusUser/{{$p->id_user}}"><i class="glyphicon glyphicon-trash"></i></a>
                          </td>
                        </tr>
                        @endforeach
